...
interface SalesContactTemplateProps {
    name: string;
    subject: string;
    message: string;
    email: string;
...
const SalesContactTemplate = ({
    name,
    subject,
    message,
    email,
}: SalesContactTemplateProps) => {
    return (
        <Html>
            <Tailwind>
                    ...
                    <Container className="bg-white mx-auto max-w-xl px-4 pt-6">
                        <div className="bg-[#fff3e1] pt-6 px-6 pb-3">
                            ...
                            <Text className="leading-relaxed text-midnight">
                                Hey, we just got a new contact form submission. Here’s the data:
                            </Text>
                            ...
                            >
                                <tbody>
                                    ...
                                    >
                                        <td style={{ fontWeight: "bold", padding: "6px" }}>Subject:</td>
                                        <td style={{ padding: "6px" }}>{subject}</td>
                                    </tr>
                                    <tr>
                                        <td style={{ fontWeight: "bold", padding: "6px" }}>Message:</td>
...
export default SalesContactTemplate